...
-- Records of sys_dept
-- ----------------------------
INSERT INTO `sys_dept` VALUES (1, '总公司', 0, '0', 1, 1, 0, NULL, '2023-12-08 00:20:29', 1, 1);
...
-- Records of sys_menu
-- ----------------------------
INSERT INTO `sys_menu` VALUES (1, 0, '0', '系统管理', 2, '/system', 'Layout', NULL, 1, 2, 'system', '/system/user', '2021-08-28 09:12:21', NULL, NULL, NULL);
...
INSERT INTO `sys_menu` VALUES (36, 0, '0', '组件封装', 2, '/component', 'Layout', NULL, 1, 4, 'menu', '', '2022-10-31 09:18:44', NULL, NULL, NULL);
...
INSERT INTO `sys_menu` VALUES (40, 0, '0', '系统工具', 2, '/tools', 'Layout', NULL, 1, 3, 'api', '', '2022-02-17 22:51:20', NULL, 1, NULL);
...
) ENGINE = InnoDB AUTO_INCREMENT = 132 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '角色表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of sys_role
-- ----------------------------
INSERT INTO `sys_role` VALUES (1, '系统管理员', 'ADMIN', 1, 1, 1, 0, '2021-03-25 12:39:54', NULL);
INSERT INTO `sys_role` VALUES (2, '普通角色', 'USER', 2, 1, 0, 0, NULL, NULL);
...
-- Records of sys_user
-- ----------------------------
INSERT INTO `sys_user` VALUES (1, 'admin', '系统管理员', 1, '$2a$10$xVWsNOhHrCxh5UbpCE7/HuJ.PAOKcYAqRxD2CO2nVnJS.IAXkr5aq', 1, 'https://img1.baidu.com/it/u=3196140437,2370538747&fm=253&fmt=auto&app=138&f=JPEG?w=506&h=500', '17621210366', 1, '', 0, '2019-10-10 13:41:22', '2022-07-31 12:39:30');
